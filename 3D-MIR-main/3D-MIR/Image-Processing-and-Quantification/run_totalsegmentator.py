...
task_list = ['Task07_Pancreas'] 

# TotalSegmentator version used v1.5.7 https://github.com/wasserth/TotalSegmentator/tree/v1.5.7
input_path_pattern = r'C:\Users\ADMIN\Desktop\Workspace\Code\data\msd\###\imagesTr'
sys.path.append(r'C:\Users\ADMIN\Desktop\Workspace\Code\models\TotalSegmentator-1.5.7\bin')
...
for task_name in task_list:
    ...
    for f in files:
        ...
        command = ['TotalSegmentator', \
                    ...
                    '-o', output_file,  '-ml' , '--fast'] #, '--statistics']
